 ...
 */
public class ProductGridViewAdapter extends ArrayAdapter<ParseObject> {
    public static final String TAG = "ProductGridViewAdapter";
    ...
    public ProductGridViewAdapter(Context context, int resource, ArrayList<ParseObject> objects) {
